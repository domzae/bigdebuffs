...
addon.Spells = {
    ...
    [223929] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true }, -- Necrotic Wound
    ...
    [131894] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true }, -- A Murder of Crows (Beast Mastery, Marksmanship)
        [206505] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true, parent = 131894 }, -- A Murder of Crows (Survival)
    ...
    [343721] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true }, -- Final Reckoning
    ...
    [322459] = { type = BUFF_OTHER }, -- Thoughtstolen (Shaman)
        [322464] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Mage)
        [322442] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Druid)
        [322462] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Priest - Holy)
        [322457] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Paladin)
        [322463] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Warlock)
        [322461] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Priest - Discipline)
        [322458] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Monk)
        [322460] = { type = BUFF_OTHER, parent = 322459 }, -- Thoughtstolen (Priest - Shadow) 
    [323673] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true }, -- Mindgames
    [329543] = { type = BUFF_DEFENSIVE }, -- Divine Ascension
        [328530] = { type = IMMUNITY, parent = 329543 }, -- Divine Ascension
    [335467] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true }, -- Devouring Plague
    ...
    [79140] = { type = BUFF_OFFENSIVE, nounitFrames = true, nonameplates = true }, -- Vendetta
    ...
    [208086] = { type = BUFF_OTHER, nounitFrames = true, nonameplates = true }, -- Colossus Smash
